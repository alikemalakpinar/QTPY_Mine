...
class EmergencyScreen(QWidget):
    ...
    def create_header(self):
        ...
        test_btn.setStyleSheet(AicoTheme.get_button_style('danger'))
    ...
    def create_stats(self):
        ...
        self.stat_cards = []
        cards_data = [
            ('active_emergencies', '🚨', '0', AicoTheme.DANGER),
            ('response_time', '⏱️', '< 2 ' + self.i18n.t('min_ago'), AicoTheme.SUCCESS),
            ('evacuation_status', '🚻', self.i18n.t('all_clear'), AicoTheme.SUCCESS),
            ('emergency_contacts', '📞', '24/7', AicoTheme.PRIMARY)
        ]
    ...
    def create_emergencies_section(self):
        ...
        self.emergency_list.setStyleSheet(f"""
            ...
            QListWidget::item {{
                ...
                border-left: 4px solid {AicoTheme.DANGER};
                border-radius: 8px;
                padding: 15px;
                margin-bottom: 10px;
                color: {AicoTheme.TEXT_PRIMARY};
    ...
    def create_contacts_section(self):
        ...
        protocol_label = QLabel(
            ...
            <span style='font-size: 11px; color: {AicoTheme.TEXT_SECONDARY};'>
        ...
        protocol_label.setStyleSheet(f"""
            QLabel {{
                ...
                border-radius: 8px;
                padding: 15px;
                border-left: 4px solid {AicoTheme.WARNING};
            }}
        """)
